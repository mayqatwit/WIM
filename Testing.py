...
java_reciever_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
java_reciever_socket.bind(('localhost', 12345))
java_reciever_socket.listen(1)
...
while connected:
    ...
    java_sender_socket, address = java_reciever_socket.accept()
